...
// ================================================================
// *** Project Select Configs
// ================================================================

export type ProjectContractor = "capacitaenlinea" | "crea" | "newcap";

export const PROJECT_CONTRACTOR_OPTIONS: { key: ProjectContractor; label: string }[] = [
    { key: "capacitaenlinea", label: "Capacita en Linea" },
    { key: "crea", label: "Crea" },
    { key: "newcap", label: "Newcap" },
];

export type ProjectCompany = "capacitaenlinea" | "audiomusica" | "santotomas";

export const PROJECT_COMPANY_OPTIONS: { key: ProjectCompany; label: string }[] = [
    { key: "capacitaenlinea", label: "Capacita en Linea" },
    { key: "audiomusica", label: "Audiomusica" },
    { key: "santotomas", label: "Santo Tomás" },
];

export type ProjectFeeStatus = "pending" | "sent" | "paid" | "archived";

export const FEE_STATUS_OPTIONS: { key: ProjectFeeStatus; label: string; color: string }[] = [
...
export const FEE_STATUS_COLOR_MAP: Record<ProjectFeeStatus, "danger" | "primary" | "success" | "warning"> = {
    pending: "danger",
    sent: "primary",
    paid: "success",
    archived: "warning",
...
export type TaskTag = "management" | "po" | "web_design" | "ux_ui" | "frontend" | "backend" | "qa" | "fix" | "dev_ops";
