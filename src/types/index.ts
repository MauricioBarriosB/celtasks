...
// ================================================================
// *** Contractor / Company Lookups (CRUD via /admin)
// ================================================================
...
export const STATUS_BORDER_LEFT_MAP: Record<TaskStatus, string> = {
    backlog: "border-l-default-400",
    in_progress: "border-l-primary",
    rev_qa: "border-l-warning",
    finished: "border-l-success",
    in_production: "border-l-secondary",
};
...
export interface ProjectStatsData {
    ...
    tagStats: Record<TaskTag | "none", number>;
    feeStats: Record<ProjectFeeStatus | "none", number>;
    hoursStats: {
        estimated: number;
        planned: number;
        completed: number;
    ...
    topContributors: { id: number; name: string; total: number; completed: number }[];
    overdueCount: number;
