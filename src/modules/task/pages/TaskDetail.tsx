...
import { KANBAN_COLUMNS, PRIORITY_OPTIONS, PRIORITY_COLOR_MAP } from "@/types";
            ...
            <Card className="mb-6">
                ...
                <CardBody className="gap-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <Input type="date" label="Date Start" placeholder=" " value={dateStart} onValueChange={setDateStart} />
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <Input type="date" label="Date End" placeholder=" " value={dateEnd} onValueChange={setDateEnd} />
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <Input
                            type="number"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                        {task.taskCode && (
                            <div className="flex items-center gap-2 sm:col-span-2">
                                <span className="text-default-400">Code:</span>
