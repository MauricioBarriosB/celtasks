        ...
        <div className="flex min-h-[calc(100vh-200px)] items-center justify-center px-4">
            <Card className="w-full max-w-md">
                <CardHeader className="flex flex-col items-center gap-1 pb-0">
                    ...
                    <p className="text-sm text-default-500">Welcome back to CelTasks</p>
                </CardHeader>
                <CardBody>
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <Input
                            ...
                            onValueChange={(val) => setCredentials((prev) => ({ ...prev, email: val }))}
                            isRequired
                            autoComplete="email"
                        />
                        ...
                        <Input
                            ...
                            onValueChange={(val) => setCredentials((prev) => ({ ...prev, password: val }))}
                            isRequired
