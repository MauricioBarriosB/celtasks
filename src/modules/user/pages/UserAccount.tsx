...
export default function UserAccount() {
    ...
    const passwordToggle = (visible: boolean, toggle: () => void, label: string) => (
        <button type="button" className="focus:outline-none" onClick={toggle} aria-label={label}>
            {visible ? (
                ...
                <CardBody>
                    <form onSubmit={handleProfileSubmit} className="flex flex-col gap-4">
                        ...
                        <div className="flex justify-end">
                            <Button type="submit" color="primary" isLoading={profileSaving || isLoading}>
                                Save Profile
                            </Button>
                        </div>
                    </form>
            ...
            <Card>
                ...
                <CardBody>
                    <form onSubmit={handlePasswordSubmit} className="flex flex-col gap-4">
                        {passwordError && (
                            <div className="rounded-lg bg-danger-50 p-3 text-sm text-danger">{passwordError}</div>
                        )}
                        ...
                        <div className="flex justify-end">
                            <Button type="submit" color="primary" isLoading={passwordSaving}>
                                Update Password
                            </Button>
                        </div>
                    </form>
