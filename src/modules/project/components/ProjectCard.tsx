                ...
                <div className="flex items-center justify-between">
                    ...
                    {project.devLink && (
                        <a
                            ...
                            className="ml-auto flex items-center gap-1 text-sm text-primary font-medium pr-4"
                        >
                            <ExternalLink className="w-4 h-4" /> Prod
                        </a>
                    )}
                    <span
                        aria-hidden="true"
                        className="flex items-center gap-1 text-sm text-primary font-medium pointer-events-none"
                    >
