...
import { KanbanSquare, CheckSquare, Users, Shield } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    description:
      "Work together with your team. Assign tasks, share progress, and keep everyone in sync.",
  },
  {
    icon: Shield,
    title: "Admin Dashboard",
    description:
      "Manage users, roles, and permissions. Monitor activity and keep your workspace organized.",
  },
];
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="flex w-full flex-col items-center justify-center gap-6 px-4 py-12 sm:py-16 text-center">
        ...
        <p className="text-xl text-default-500 sm:text-2xl">
          Task Management &amp; Kanban Board
        </p>
        <p className="max-w-2xl text-default-400">
          Streamline your projects with an intuitive task management platform.
          Organize work with kanban boards, collaborate with your team, and
