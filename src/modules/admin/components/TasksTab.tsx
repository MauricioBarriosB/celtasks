...
import { Input, Button, Chip, useDisclosure, Spinner, addToast } from "@heroui/react";
...
export default function TasksTab() {
    ...
    const projectGroups: ProjectGroup[] = useMemo(() => {
        ...
        return Array.from(groupMap.values()).sort((a, b) => a.projectName.localeCompare(b.projectName));
    }, [tasks, search]);
        ...
        <>
            <div className="mb-4 flex items-center gap-4">
                ...
                <span className="text-sm text-default-500">
                    {totalTasks} task{totalTasks === 1 ? "" : "s"} in {projectGroups.length} project
