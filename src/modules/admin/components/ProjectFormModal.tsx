...
export default function ProjectFormModal({ project, isOpen, onClose, onSaved }: Readonly<ProjectFormModalProps>) {
    const [form, setForm] = useState({ name: "", description: "", status: "active", totalHhs: 0, totalCost: 0, dateStart: "", dateEnd: "" });
    ...
    useEffect(() => {
        if (isOpen) {
            if (project) {
                ...
                setForm({ name: "", description: "", status: "active", totalHhs: 0, totalCost: 0, dateStart: "", dateEnd: "" });
            }
        }
    }, [isOpen, project]);
