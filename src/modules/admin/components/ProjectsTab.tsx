...
import { Plus, Pencil, Trash2, UserPlus, KanbanSquare, Search, BarChart3 } from "lucide-react";
...
export default function ProjectsTab() {
    ...
    const statusColor = (status: string) => PROJECT_STATUS_COLOR_MAP[status as ProjectStatus] ?? "default";
                            ...
                            <TableCell>
                                <div className="flex items-center gap-2">
                                    <Button
                                        ...
                                        onPress={() => handleEditOpen(project)}
                                    >
                                        <Pencil size={14} />
                                    </Button>
                                    <Button
                                    ...
                                    <Button
                                        ...
                                        onPress={() => navigate(`/admin/projects/${project.id}/users`)}
                                    >
                                        Users
                                    </Button>
                                    <Button
                                        ...
                                        onPress={() => navigate(`/admin/projects/${project.id}/stats`)}
                                    >
                                        Stats
                                    </Button>
                                    <Button
                                        ...
                                        onPress={() => handleDeleteOpen(project)}
                                    >
                                        <Trash2 size={14} />
                                    </Button>
                                </div>
