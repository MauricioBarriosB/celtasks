...
import { Card, CardBody, CardHeader, Button, Chip, Input, Spinner, addToast } from "@heroui/react";
        ...
        <div>
            <div className="flex items-center gap-3 mb-6">
                <div className="flex-1">
                    <h1 className="text-2xl font-bold">Manage Users{project ? ` | ${project.name}` : ""}</h1>
                    <p className="text-sm text-default-500">Assign or remove users from this project</p>
                </div>
                ...
                <Card>
                    ...
                    <CardBody>
                        {assignedUsers.length === 0 ? (
                            <p className="py-8 text-center text-default-400">No users assigned yet.</p>
                        ) : (
                    ...
                    <CardBody>
                        {availableUsers.length === 0 ? (
                            <p className="py-8 text-center text-default-400">
                                {search.trim() ? "No users match your search." : "All users are already assigned."}
                            </p>
                        ) : (
                            <div className="flex flex-col gap-2">
