...
import type { Task, TaskStatus, Project, User as UserType, TaskReorderItem } from "@/types";
...
export default function KanbanBoard() {
    ...
    useEffect(() => {
        if (projectId) localStorage.setItem(`celtasks_kanban_view_${projectId}`, "board");
    }, [projectId]);
