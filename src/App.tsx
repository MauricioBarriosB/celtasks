...
const KanbanList = lazy(() => import("@modules/kanban/pages/KanbanList"));
...
const ProjectStatsPage = lazy(() => import("@modules/admin/pages/ProjectStatsPage"));
